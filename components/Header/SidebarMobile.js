...
export const SidebarMobile = () => {
  ...
  return (
    <>
      ...
      <div className={`${open ? "right-0" : "-right-96"} h-screen rounded-b-lg duration-300 p-10 shadow-2xl fixed top-16 peer:transition ease-out delay-150 md:hidden bg-white`}>
